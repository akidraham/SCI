(function (global, factory) {
  ...
  // tambahan dari deepseek referensi https://chat.deepseek.com/a/chat/s/ed0229ef-48d8-42c5-b67d-b973774ac095
  exports.Ellipsed = class Ellipsed {
    ...
    init() {
      ...
      if (this.options.responsive) {
        this.listener = this.addResponsiveListener();
      }
    }

    applyEllipsis() {
      ellipsis(this.element, this.options.lines, this.options);
    }
  ...
  if (typeof window !== "undefined" && window.document) {
    window.Ellipsed = exports.Ellipsed;
  }
});
